          ...
          <FadeIn delay={0.15}>
            <div className="bg-green-50 rounded-2xl p-8 md:p-12 max-w-3xl mx-auto">
              <h3 className="text-xl font-bold text-brown-800">
                助成金を活用すれば、実質約1万5,000円〜受講可能。
              </h3>
              <p className="mt-4 text-brown-600 leading-relaxed">
                研修費用は10万円（税込・プログラム内容により変動）。厚生労働省の「人材開発支援助成金」を活用することで、中小企業の場合は研修費用の最大75%が助成されます。つまり、実質的な企業負担は約1万5,000円〜2万5,000円程度になるケースが多くあります。
              </p>
              <p className="mt-4 text-sm text-brown-500">
                ※助成金の受給には一定の要件があります。詳細はお問い合わせください。
              </p>
            </div>
          </FadeIn>
        </div>
